 ...
 * lock, dispatches the type effect. The effect is resolved by type via RequestEffectFactory
 * — for an attendance adjustment, add records a punch, void records an annulment, amend
 * does both. If the effect throws (e.g. InvalidAdjustmentTarget, 422 — the target punch was
